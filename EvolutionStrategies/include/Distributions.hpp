#ifndef EVOLUTIONARYALGORITHMS_DISTRIBUTIONS_HPP
#define EVOLUTIONARYALGORITHMS_DISTRIBUTIONS_HPP

#include <random>

namespace ES {
struct Distributions {
    explicit Distributions(std::size_t noParents) :
        parents{0, noParents - 1} {}
    ...
    std::uniform_int_distribution<std::size_t> parents{};
};
} // namespace ES

#endif // EVOLUTIONARYALGORITHMS_DISTRIBUTIONS_HPP
