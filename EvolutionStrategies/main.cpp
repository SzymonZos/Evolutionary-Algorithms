...
int main() {
    ...
    //    coefficientsDistribution{-10.0, 10.0};
    //    std::uniform_real_distribution<>
    //    standardDeviationsDistribution{0.0, 10.0};
    ...
    //        return
    //        parents[static_cast<std::size_t>(parentsDistribution(rng))];
    //    });
    //
    ...
    IntArray<3> test = {1, 2, 3};
    IntArray<3> test2 = {6, 10, 20};

    test += {2, 5, 6};
    std::cout << test;

    ES::Chromosome<3>::Params duupa;
